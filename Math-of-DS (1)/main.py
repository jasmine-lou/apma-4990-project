...
def keep_necessary_cols_airbnb_only(dff):
  ...
  df = dff[['room_type', 'price', 'minimum_nights', 'number_of_reviews', 'reviews_per_month', 'calculated_host_listings_count', 'availability_365','Name']]
...
if __name__ == "__main__":
  ...
  #two_comp = pca.components_[0:6].T
  #print(two_comp)
  ...
  #X, X_TTT, y, y_TTT = train_test_split(X,y,test_size=0.3)
  ...
  for i in range(0,500):
    ...
    # print(X_reduced_train.columns)
    # print(X_reduced_test.columns)
    # print(y_train)
    # print(y_test)

    train_mean = X_reduced_train.mean()
    train_std = X_reduced_train.std() 
    X_reduced_train = (X_reduced_train - train_mean / train_std)
    X_reduced_test = (X_reduced_test - train_mean / train_std)
    ...
    take_mean.append(regr.coef_)
    take_mean_i.append(regr.intercept_)
    ...
    #y_train_pred = list(regr.predict(X_reduced_train[:,:6]))
