...
if __name__ == "__main__":
  ...
  for i in range(0,1000):
    ...
    if r2_score(y_test, y_test_pred) > 0:
      coeffs.append(r2_score(y_test, y_test_pred))

  print(sum(coeffs) / len(coeffs))

  

'''
ran with both: .57
ran with just housing metrics: .43
ran with just airbnb: .38

TO DO:
Interpret PCA results on new dataset
Try cross fold validation to train different models and average them (or boosting and bagging), etc.
Write up what we did and steps for future improvements
'''